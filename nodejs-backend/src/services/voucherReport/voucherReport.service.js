const { VoucherReport } = require("./voucherReport.class");
const createModel = require("./voucherReport.model");
const hooks = require("./voucherReport.hooks");
...
module.exports = function (app) {
  ...
  app.use("/voucherReport", new VoucherReport(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("voucherReport");

  // Get the schema of the collections 
  app.get("/voucherReportSchema", function (request, response) {
