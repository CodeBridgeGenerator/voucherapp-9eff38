const { VoucherCategory } = require("./voucherCategory.class");
const createModel = require("./voucherCategory.model");
const hooks = require("./voucherCategory.hooks");
...
module.exports = function (app) {
  ...
  app.use("/voucherCategory", new VoucherCategory(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("voucherCategory");

  // Get the schema of the collections 
  app.get("/voucherCategorySchema", function (request, response) {
