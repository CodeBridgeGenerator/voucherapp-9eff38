...
import seederData from "./voucherReport.seeder.json";
...
const VoucherReportSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VoucherReportSeederDialogComponent);
