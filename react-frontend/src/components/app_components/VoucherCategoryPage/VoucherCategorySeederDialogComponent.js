...
import seederData from "./voucherCategory.seeder.json";
...
const VoucherCategorySeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VoucherCategorySeederDialogComponent);
