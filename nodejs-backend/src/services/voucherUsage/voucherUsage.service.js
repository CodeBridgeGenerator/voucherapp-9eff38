const { VoucherUsage } = require("./voucherUsage.class");
const createModel = require("./voucherUsage.model");
const hooks = require("./voucherUsage.hooks");
...
module.exports = function (app) {
  ...
  app.use("/voucherUsage", new VoucherUsage(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("voucherUsage");

  // Get the schema of the collections 
  app.get("/voucherUsageSchema", function (request, response) {
