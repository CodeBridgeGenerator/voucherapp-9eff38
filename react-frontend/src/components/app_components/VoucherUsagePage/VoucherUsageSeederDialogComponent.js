...
import seederData from "./voucherUsage.seeder.json";
...
const VoucherUsageSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(VoucherUsageSeederDialogComponent);
